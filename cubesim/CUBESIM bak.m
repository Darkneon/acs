...
%*
%*    version 2.2.2, November 5, 2002.  
%*    
%*    Copyright (C) 2002-2003 Jean-Francois Levesque  
%*    
...
%*  LL2XYZ, XYZ2LL      	(coordinate transformation)
...
if strcmp(action, 'initialize')
   ...
   h0 = figure('Color',[0.8 0.8 0.8], ...%'FileName','C:\MATLAB\work\CUBESIM.m', ...
      'PaperPosition',[18 180 576 432], 'PaperUnits','points', 'menubar','none',...
      'Position',[0 35 ScreenSize-[0 64]], 'Tag','ControlWindow', 'ToolBar','none',...
      'Name','CUBESIM - CubeSat Orbit & Attitude Simulator v2.2');
   ...
   h1 = axes('Parent',h0, 'Units','pixels', 'Box','on', 'CameraUpVector',[0 1 0], ...
   ...
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback','cubeSim(''hideLeg'')', ...        
   ...
   h1 = axes('Parent',h0, 'Units','pixels', 'Box','off',...
   ...
   cmdList=str2mat( ...
      ' set(findobj(gcf, ''Tag'', ''PlotOrbShape''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotOrbShapeLeg''), ''Visible'',''on'');', ...
      ' set(findobj(gcf, ''Tag'', ''PlotTrkAngle''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotTrkAngleLeg''), ''Visible'',''on'');', ...
      ' set(findobj(gcf, ''Tag'', ''PlotTrkRange''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotTrkRangeLeg''), ''Visible'',''on'');', ...
      ' set(findobj(gcf, ''Tag'', ''PlotTrkDoppler''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotTrkDopplerLeg''), ''Visible'',''on'');',...
      ' set(findobj(gcf, ''Tag'', ''PlotTrkAngleTime''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotTrkAngleTimeLeg''), ''Visible'',''on'');', ...
      ' set(findobj(gcf, ''Tag'', ''PlotTrkRangeTime''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotTrkRangeTimeLeg''), ''Visible'',''on'');', ...
      ' set(findobj(gcf, ''Tag'', ''PlotTrkDopplerTime''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotTrkDopplerTimeLeg''), ''Visible'',''on'');',...
      ' set(findobj(gcf, ''Tag'', ''PlotMagSim''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotMagSimLeg''), ''Visible'',''on'');',...
      ' set(findobj(gcf, ''Tag'', ''PlotMagSimTime''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotMagSimTimeLeg''), ''Visible'',''on'');',...
      ' set(findobj(gcf, ''Tag'', ''PlotRateTime''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotRateTimeLeg''), ''Visible'',''on'');',...
      ' set(findobj(gcf, ''Tag'', ''PlotAntPoint''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotAntPointLeg''), ''Visible'',''on'');',...
      ' set(findobj(gcf, ''Tag'', ''PlotAntPointTime''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotAntPointTimeLeg''), ''Visible'',''on'');',...
      ' set(findobj(gcf, ''Tag'', ''PlotRadArea''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotRadAreaLeg''), ''Visible'',''on'');', ...
      ' set(findobj(gcf, ''Tag'', ''PlotRadPower''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotRadPowerLeg''), ''Visible'',''on'');', ...
      ' set(findobj(gcf, ''Tag'', ''PlotRadInput2''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotRadInput2Leg''), ''Visible'',''on'');',...
      ' set(findobj(gcf, ''Tag'', ''PlotRadTemp2''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotRadTemp2Leg''), ''Visible'',''on'');',...
      ' set(findobj(gcf, ''Tag'', ''PlotRadInput7''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotRadInput7Leg''), ''Visible'',''on'');',...
      ' set(findobj(gcf, ''Tag'', ''PlotRadTemp7''), ''Visible'',''on'');set(findobj(gcf, ''Tag'', ''PlotRadTemp7Leg''), ''Visible'',''on'');',...
      ' figure(findobj(''Tag'',''PlotTrace3Dgeo'',''Type'',''figure''))',...
      ' figure(findobj(''Tag'',''PlotTrace3Dsun'',''Type'',''figure''))');
   
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[0.8 0.8 0.8], 'FontWeight', 'Bold', 'HorizontalAlignment', 'Right', ...
      'Position',[FrameEnd-[315 360] 90 15], 'String', 'Select Graph', 'Style','text', 'Tag','StaticText1'); 
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'BackgroundColor',[1 1 1], 'Callback','cubeSim(''plot'')', ...
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[1 1 1], 'FontWeight', 'Bold', 'HorizontalAlignment', 'Left', ...
      'Position',[FrameStart 575 45], 'String', {'CubeSat Orbit & Attitude Simulator'}, 'Style','list', 'Tag','TextDisplay');    

   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback','cubeSim(''info'')', ...        
      'Position',[8 15 35 35], 'String', '?', 'Style','pushbutton', 'Tag','ButtonInfo',...
      'fontweight', 'bold', 'fontsize', [20], 'BackgroundColor', [0.7 0 1]);
   
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback','cubeSim(''history'')', ...        
      'Position',[FrameStart(1)+580 FrameStart(2)+5 75 30], 'String', 'Data Log', 'Style','pushbutton', 'Tag','ButtonHistory',...
      'UserData', 'No Data Yet, Run Simulation First');
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback', 'cubeSim(''clearGraph'');',...
      'Position',[FrameStart(1)+660 FrameStart(2)+5 80 30], 'String', 'Clear Graphs', 'Style','pushbutton', 'Tag','ButtonClr');
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback','cubeSim(''plotMag'')', ...        
      'Position',[FrameStart(1)+745 FrameStart(2)+5 75 30], 'String', 'Plot L-Shell', 'Style','pushbutton', 'Tag','ButtonPlot');
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback','cubeSim(''plotHyst'')', ...        
      'Position',[FrameStart(1)+825 FrameStart(2)+5 75 30], 'String', 'Plot Models', 'Style','pushbutton', 'Tag','ButtonPlotH');
   %h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback', 'set(findobj(gcf,''style'',''edit''),''string'','''');',...
   %   'Position',[FrameStart(1)+825 FrameStart(2)+5 80 30], 'String', 'Clear Fields', 'Style','pushbutton', 'Tag','ButtonFld');
   %h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'cubesim(''setDefault'');',...
   %   'Position',[FrameStart(1)+825 FrameStart(2)+5 80 30], 'String', 'Default', 'Style','pushbutton', 'Tag','ButtonFld');
   
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'BackgroundColor', [0.8 0.8 0.8], 'FontWeight', 'Bold', 'Callback',...
      'set(findobj(gcf,''tag'',''ButtonSW1''),''userdata'',1);set(findobj(gcf,''tag'',''ButtonSW2''),''value'',0);set(findobj(gcf,''tag'',''ButtonSW3''),''value'',0);cubeSim(''eval'');',...
      'Position',[FrameStart(1)+920 FrameStart(2)+24 130 12], 'String', 'Hysteresis model 1', 'Style','radiobutton', 'Tag','ButtonSW1',...
      'UserData',1, 'value', 1);
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'BackgroundColor', [0.8 0.8 0.8], 'FontWeight', 'Bold', 'Callback',...
      'set(findobj(gcf,''tag'',''ButtonSW1''),''userdata'',2);set(findobj(gcf,''tag'',''ButtonSW1''),''value'',0);set(findobj(gcf,''tag'',''ButtonSW3''),''value'',0);cubeSim(''eval'');',...
      'Position',[FrameStart(1)+920 FrameStart(2)+12 130 12], 'String', 'Hysteresis model 2', 'Style','radiobutton', 'Tag','ButtonSW2');
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'BackgroundColor', [0.8 0.8 0.8], 'FontWeight', 'Bold', 'Callback',...
      'set(findobj(gcf,''tag'',''ButtonSW1''),''userdata'',3);set(findobj(gcf,''tag'',''ButtonSW1''),''value'',0);set(findobj(gcf,''tag'',''ButtonSW2''),''value'',0);cubeSim(''eval'');',...
      'Position',[FrameStart(1)+920 FrameStart(2)+0 130 12], 'String', 'Hysteresis model 3', 'Style','radiobutton', 'Tag','ButtonSW3');
   
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback', 'cubeSim(''close'');cubeSim(''initialize'',''default'');',...
      'Position',[FrameEnd(1)-170 FrameStart(2) 80 35], 'String', 'Reset', 'Style','pushbutton', 'Tag','ButtonDef');
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback','cubeSim(''close'')', ...        
...
%   FrameEnd = [1270 930];
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',FrameColor, 'Units','pixels', ...
      'Position',[FrameStart FrameSize], 'Style','frame', 'Tag','FrameSim');
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[0.8 0.8 0.8], 'FontWeight', 'Bold', 'fontsize', [10],...
      'Position',[FrameEnd-[95 25] [90 25]-[10 10]], 'Style','text', 'String', 'Sim', 'Tag','StaticTextSim'); 
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback','cubeSim(''simInfo'')', ...        
      'Position',[FrameEnd-[25 25] 15 15], 'String', '?', 'Style','pushbutton', 'Tag','ButtonInfo');
    
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[1 1 1], 'Units','pixels', 'Callback', ...
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',TextBoxColor, 'FontWeight', 'Bold', 'HorizontalAlignment', 'Center', ...
      'Position',[FrameEnd-[95 42] 85 15], 'String', 'Duration','BackgroundColor',FrameColor,'Style', 'text', 'Tag','StaticText1');
   h1 = uicontrol('Parent',h0, 'BackgroundColor',TextBoxColor, 'FontWeight', 'Bold', 'HorizontalAlignment', 'Right', ...
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',TextBoxColor, 'FontWeight', 'Bold', 'HorizontalAlignment', 'Left', ...
   ...
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback','', ...        
...
%   FrameEnd = [1165 820];
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[0.8 0.8 0.8],...
      'Position',[FrameStart(1) FrameEnd(2) 310 20], 'Style','text', 'FontSize', [6],...
      'String', 'CubeSim v2.2 - (C) 2003 Jeff Levesque ( jflev@yahoo.ca )', 'Tag','StaticTextSim'); 
   ...
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback','cubeSim(''orbitInfo'')', ...        
      'Position',[FrameEnd-[25 25] 15 15], 'String', '?', 'Style','pushbutton', 'Tag','ButtonInfo');
   
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[1 1 1], 'Units','pixels', 'Callback','cubeSim(''eval'')', ...
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[0.9 0.9 0.9], 'Units','pixels',  'Callback','cubeSim(''eval'')',...      'Position',[FrameEnd-[60 235] 55 20], 'String',sprintf('%0.2g',abs(Decay)), 'Style','edit', 'Tag','EditTextDecay');
   %h1 = uicontrol('Parent',h0, 'BackgroundColor',[0.9 0.9 0.9], 'Units','pixels', 'Callback','cubeSim(''eval'')', ...
...
%   FrameEnd = [1270 555];  
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',BackColor, 'Units','pixels', ...
...
%   FrameEnd = [1270 395];
   ...
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback','cubeSim(''scInfo'')', ...        
      'Position',[FrameEnd-[25 25] 15 15], 'String', '?', 'Style','pushbutton', 'Tag','ButtonInfo');
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[1 1 1], 'Units','pixels', 'Callback','cubeSim(''testfs'');cubeSim(''eval'')', ...
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[1 1 1], 'Units','pixels', 'Callback','cubesim(''setCd''),cubeSim(''eval'')', ...
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[1 1 1], 'Units','pixels', 'Callback','cubesim(''setCb''),cubeSim(''eval'')', ...
...
%   FrameEnd = [1270 250];
   ...
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback','cubeSim(''magInfo'')', ...        
      'Position',[FrameEnd-[25 25] 15 15], 'String', '?', 'Style','pushbutton', 'Tag','ButtonInfo');
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[1 1 1], 'Units','pixels', 'Callback','cubeSim(''setmhyst1'');cubeSim(''eval'')', ...
      'Position',[FrameEnd-[180 85] 40 20], 'String',sprintf('%0.4g',mhyst1*1e3), 'Style','edit', 'Tag','EditTextmhyst1', 'UserData',mhyst1);    
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[1 1 1], 'Units','pixels', 'Callback','cubeSim(''setVhyst1'');cubeSim(''eval'')', ...
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[1 1 1], 'Units','pixels', 'Callback','cubeSim(''setmhyst2'');cubeSim(''eval'')', ...
      'Position',[FrameEnd-[180 105] 40 20], 'String',sprintf('%0.4g',mhyst2*1e3), 'Style','edit', 'Tag','EditTextmhyst2', 'UserData',mhyst2);    
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[1 1 1], 'Units','pixels', 'Callback','cubeSim(''setVhyst2'');cubeSim(''eval'')', ...
...
%      'Position',[FrameEnd-[150 142] 100 15], 'String', 'Nutation freq [°/s]', 'Style','text', 'Tag','StaticText1'); 
   ...
   h1 = uicontrol('Parent',h0, 'BackgroundColor',[0.9 0.9 0.9], 'Units','pixels', 'Callback','cubeSim(''testfs'');cubeSim(''eval'')', ...
...
%   FrameEnd = [1270 145];
   ...
   h1 = uicontrol('Parent',h0, 'Units','pixels', 'FontWeight', 'Bold', 'Callback','cubeSim(''gsInfo'')', ...        
      'Position',[FrameEnd-[25 25] 15 15], 'String', '?', 'Style','pushbutton', 'Tag','ButtonInfo');
   ...
   %============================================================
   LocalUpdateGraphs;
   LocalDisplay('CubeSat Orbit & Attitude Simulator v2.2 - (C) 2003, Jean-Francois Levesque (jflev@yahoo.ca)', 'new')
...
elseif strcmp(action, 'qnorm')
   q1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextq1'),'String'), '%f');	%[] quaternion
   q2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextq2'),'String'), '%f');	%[] quaternion
   q3 = sscanf(get(findobj(gcf, 'Tag', 'EditTextq3'),'String'), '%f');	%[] quaternion
   q4 = sscanf(get(findobj(gcf, 'Tag', 'EditTextq4'),'String'), '%f');	%[] quaternion
   q0 = [q1; q2; q3; q4]./sqrt(q1^2+q2^2+q3^2+q4^2); 		% intitial quaternion
   set(findobj(gcf, 'Tag', 'EditTextq1'),'String',sprintf('%0.3g',q0(1)));	
   set(findobj(gcf, 'Tag', 'EditTextq2'),'String',sprintf('%0.3g',q0(2)));	
   set(findobj(gcf, 'Tag', 'EditTextq3'),'String',sprintf('%0.3g',q0(3)));	
   set(findobj(gcf, 'Tag', 'EditTextq4'),'String',sprintf('%0.3g',q0(4)));	

elseif strcmp(action, 'testfs')
   fs = sscanf(get(findobj(gcf, 'Tag', 'EditTextfs'),'String'), '%f'); 	      	%[s]
   wbx = sscanf(get(findobj(gcf, 'Tag', 'EditTextwbx'),'String'), '%f');%[rad/s] 
   wby = sscanf(get(findobj(gcf, 'Tag', 'EditTextwby'),'String'), '%f');%[rad/s] 
   wbz = sscanf(get(findobj(gcf, 'Tag', 'EditTextwbz'),'String'), '%f');%[rad/s]
   wb0 = [wbx; wby; wbz];		% initial rotation resolved in body coordinates
   Ixx = sscanf(get(findobj(gcf, 'Tag', 'EditTextIxx'),'String'), '%f')*1e-6;           %[kg.m²] 
   Iyy = sscanf(get(findobj(gcf, 'Tag', 'EditTextIyy'),'String'), '%f')*1e-6;           %[kg.m²]
   Izz = sscanf(get(findobj(gcf, 'Tag', 'EditTextIzz'),'String'), '%f')*1e-6;           %[kg.m²]
   Ixy = sscanf(get(findobj(gcf, 'Tag', 'EditTextIxy'),'String'), '%f')*1e-6;           %[kg.m²] product of inertia
   Ixz = sscanf(get(findobj(gcf, 'Tag', 'EditTextIxz'),'String'), '%f')*1e-6;           %[kg.m²] product of inertia
   Iyz = sscanf(get(findobj(gcf, 'Tag', 'EditTextIyz'),'String'), '%f')*1e-6;           %[kg.m²] product of inerti
   Isc = [Ixx Ixy Ixz; Ixy Iyy Iyz; Ixz Iyz Izz];                                 	%[kg.m²] Moment of inertia tensor
   Mmag = sscanf(get(findobj(gcf, 'Tag', 'EditTextMmag'),'String'), '%f');	%[Am^2]
   wn = sqrt(Mmag*B_EARTH/min(max(Isc)));
   set(findobj(gcf, 'Tag', 'EditTextwn'),'String',sprintf('%0.4g',wn));		%[rad/s]
   if fs < norm(wb0)/pi | fs < wn/pi	 	%Nyquist sampling criterion
      ...
      set(findobj(gcf, 'Tag', 'EditTextfs'),'ForegroundColor','r');     
      set(findobj(gcf, 'Tag', 'EditTextTs'),'ForegroundColor','r');
   else
      set(findobj(gcf, 'Tag', 'EditTextfs'),'ForegroundColor','k');     
      set(findobj(gcf, 'Tag', 'EditTextTs'),'ForegroundColor','k');
   end
   
elseif strcmp(action, 'setn')
   h = sscanf(get(findobj(gcf, 'Tag', 'EditTexth'),'String'), '%f');	%[km] altitude at perigee
   e = sscanf(get(findobj(gcf, 'Tag', 'EditTextEcc'),'String'), '%f');	%[] eccentricity
   a = (h+Re) / (1-e);							%[km] semi-major axis
   n = sqrt(GMe/a^3)/(2*pi)*Te;						%[rev/day]
   set(findobj(gcf, 'Tag', 'EditTextn'),'String',sprintf('%0.6g',n));	%[rev/day]
   set(findobj(gcf, 'Tag', 'EditTextn'),'UserData',n);			%[rev/day]
   
elseif strcmp(action, 'seth')
   n = sscanf(get(findobj(gcf, 'Tag', 'EditTextn'),'String'), '%f');    %[rev/day]
   e = sscanf(get(findobj(gcf, 'Tag', 'EditTextEcc'),'String'), '%f');	%[] eccentricity
   a = (sqrt(GMe)/(2*pi)*Te/n)^(2/3);					%[km] semi-major axis
   h = a*(1-e) - Re;							%[km] altitude at perigee
   set(findobj(gcf, 'Tag', 'EditTexth'),'String',sprintf('%0.5g',h));	%[km]
   set(findobj(gcf, 'Tag', 'EditTexth'),'UserData',h);			%[km]
   
elseif strcmp(action, 'setlast')
   %global fs
   sim_sample =  sscanf(get(findobj(gcf, 'Tag', 'EditTextSample'),'String'), '%f');	%[]
   n = sscanf(get(findobj(gcf, 'Tag', 'EditTextn'),'String'), '%f');        	%[rev/day]
   sim_dur = sscanf(get(findobj(gcf, 'Tag', 'EditTextDur'),'String'), '%f');	%[rev]
   sim_last = sim_dur / n * Te;							%[s]
   Ts = sim_last / sim_sample;							%[s]
   fs = 1/ Ts;									%[Hz]
   set(findobj(gcf, 'Tag', 'EditTextLast'),'String',sprintf('%0.4g',sim_last/60));%[min]
   set(findobj(gcf, 'Tag', 'EditTextfs'),'String',sprintf('%0.4g',fs));		%[Hz]     
   set(findobj(gcf, 'Tag', 'EditTextTs'),'String',sprintf('%0.4g',Ts));		%[s]     
   set(findobj(gcf, 'Tag', 'EditTextDur'),'UserData',sim_dur);               	%[rev]
   set(findobj(gcf, 'Tag', 'EditTextLast'),'UserData',sim_last);               	%[s]
   set(findobj(gcf, 'Tag', 'EditTextfs'),'UserData',fs);               		%[Hz]     
   set(findobj(gcf, 'Tag', 'EditTextTs'),'UserData',Ts);               		%[s] 
   
elseif strcmp(action, 'setdur')
   %global fs   
   sim_sample =  sscanf(get(findobj(gcf, 'Tag', 'EditTextSample'),'String'), '%f');	%[]
   n = sscanf(get(findobj(gcf, 'Tag', 'EditTextn'),'String'), '%f');		%[rev/day]
   sim_last = sscanf(get(findobj(gcf, 'Tag', 'EditTextLast'),'String'), '%f')*60; %[sec]
   sim_dur = n / Te * sim_last;							%[rev]
   Ts = sim_last / sim_sample;							%[s]
   fs = 1/ Ts;									%[Hz]
   set(findobj(gcf, 'Tag', 'EditTextDur'),'String',sprintf('%0.4g',sim_dur));	%[rev]   
   set(findobj(gcf, 'Tag', 'EditTextfs'),'String',sprintf('%0.4g',fs));		%[Hz]     
   set(findobj(gcf, 'Tag', 'EditTextTs'),'String',sprintf('%0.4g',Ts));		%[s]     
   set(findobj(gcf, 'Tag', 'EditTextDur'),'UserData',sim_dur);               	%[rev]
   set(findobj(gcf, 'Tag', 'EditTextLast'),'UserData',sim_last);               	%[s]
...
elseif strcmp(action, 'setfs')
   %global fs   
   sim_sample =  sscanf(get(findobj(gcf, 'Tag', 'EditTextSample'),'String'), '%f');	%[]
   Ts = sscanf(get(findobj(gcf, 'Tag', 'EditTextTs'),'String'), '%f'); 	      	%[s]
   n = sscanf(get(findobj(gcf, 'Tag', 'EditTextn'),'String'), '%f');		%[rev/day]
   fs = 1/ Ts;									%[Hz]
...
elseif strcmp(action, 'setCb')
   Cb = sscanf(get(findobj(gcf, 'Tag', 'EditTextCb'),'String'), '%f');		%[km/m^2] ballistic coef
   msc = sscanf(get(findobj(gcf, 'Tag', 'EditTextmsc'),'String'), '%f');	%[km] mass
   side = sscanf(get(findobj(gcf, 'Tag', 'EditTextcsc'),'String'), '%f');	%[m] width
   lsc = sscanf(get(findobj(gcf, 'Tag', 'EditTextlsc'),'String'), '%f');	%[m] length
   Cd = msc/side/lsc/Cb;								%[] drag coef
   set(findobj(gcf, 'Tag', 'EditTextCb'),'UserData',Cb);			%[km/m^2]   
   set(findobj(gcf, 'Tag', 'EditTextCd'),'String',sprintf('%0.3g',Cd));		%[]
   set(findobj(gcf, 'Tag', 'EditTextCd'),'UserData',Cd);			%[]
   
elseif strcmp(action, 'setCd')
   Cd = sscanf(get(findobj(gcf, 'Tag', 'EditTextCd'),'String'), '%f');		%[] drag coef
   msc = sscanf(get(findobj(gcf, 'Tag', 'EditTextmsc'),'String'), '%f');	%[km] mass
   side = sscanf(get(findobj(gcf, 'Tag', 'EditTextcsc'),'String'), '%f');	%[m] width
   lsc = sscanf(get(findobj(gcf, 'Tag', 'EditTextlsc'),'String'), '%f');	%[m] length
   Cb = msc/side/lsc/Cd;								%[km/m^2] ballistic coef
   set(findobj(gcf, 'Tag', 'EditTextCd'),'UserData',Cd);			%[]
   set(findobj(gcf, 'Tag', 'EditTextCb'),'String',sprintf('%0.3g',Cb));		%[km/m^2]
   set(findobj(gcf, 'Tag', 'EditTextCb'),'UserData',Cb);			%[km/m^2]   
...
elseif strcmp(action, 'setA2sc')
   ...
   set(findobj(gcf, 'Tag', 'EditTextA2sc'),'String',sprintf('%0.4g',A2sc));	%[m^2]
   set(findobj(gcf, 'Tag', 'EditTextA2sc'),'UserData',A2sc);			%[m^2]     
   
elseif strcmp(action, 'setA1sc')
   side = sscanf(get(findobj(gcf, 'Tag', 'EditTextcsc'),'String'), '%f');	%[m] width
   A1sc = side*side;								%[m^2] base face area
   set(findobj(gcf, 'Tag', 'EditTextA1sc'),'String',sprintf('%0.4g',A1sc));	%[m^2]
   set(findobj(gcf, 'Tag', 'EditTextA1sc'),'UserData',A1sc);			%[m^2]   
   
   
%---Mag
elseif strcmp(action, 'setVmag')
   %global uo SGalnico
   Vmag = sscanf(get(findobj(gcf, 'Tag', 'EditTextVmag'),'String'), '%f')*1e-6;	%[m^3] Volume
   Bmag = sscanf(get(findobj(gcf, 'Tag', 'EditTextBmag'),'String'), '%f');	%[Tesla] Magnetic induction (field strength)
   Mmag = Bmag * Vmag / uo;							%[A.m^2] Magnetic moment
   mmag = Vmag * (SGalnico * 1000);						%[kg] mass
   set(findobj(gcf, 'Tag', 'EditTextVmag'),'UserData',Vmag);			%[m^3] Volume
   set(findobj(gcf, 'Tag', 'EditTextmmag'),'UserData',mmag);			%[kg] mass
   set(findobj(gcf, 'Tag', 'EditTextmmag'),'String',sprintf('%0.4g',mmag*1000));%[g] mass 
   set(findobj(gcf, 'Tag', 'EditTextMmag'),'UserData',Mmag);			%[A.m^2] Magnetic moment
   set(findobj(gcf, 'Tag', 'EditTextMmag'),'String',sprintf('%0.4g',Mmag));	%[A.m^2] Magnetic moment
   
elseif strcmp(action, 'setMmag')
   %global uo SGalnico
   Mmag = sscanf(get(findobj(gcf, 'Tag', 'EditTextMmag'),'String'), '%f');	%[A.m^2] Magnetic moment
   Bmag = sscanf(get(findobj(gcf, 'Tag', 'EditTextBmag'),'String'), '%f');	%[Tesla] Magnetic induction (field strength)
   ...
   set(findobj(gcf, 'Tag', 'EditTextmmag'),'String',sprintf('%0.4g',mmag*1000));%[g] mass 
   set(findobj(gcf, 'Tag', 'EditTextVmag'),'UserData',Vmag);			%[m^3] Volume
   set(findobj(gcf, 'Tag', 'EditTextVmag'),'String',sprintf('%0.4g',Vmag*1e+6));%[cm^3] Volume  
   
elseif strcmp(action, 'setmmag')
   %global uo SGalnico
   mmag = sscanf(get(findobj(gcf, 'Tag', 'EditTextmmag'),'String'), '%f')/1000;	%[kg] mass
   Bmag = sscanf(get(findobj(gcf, 'Tag', 'EditTextBmag'),'String'), '%f');	%[Tesla] Magnetic induction (field strength)
...
elseif strcmp(action, 'setVhyst1')
   %global uo SGhymu
   Vhyst1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextVhyst1'),'String'), '%f')*1e-6;	%[m^3] Volume
   Bs1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextBs1'),'String'), '%f');		%[Tesla] Magnetic induction (field strength)
   Mhyst1 = Bs1 * Vhyst1 / uo;							%[A.m^2] Magnetic moment
   mhyst1 = Vhyst1 * (SGhymu * 1000);							%[kg] mass
   set(findobj(gcf, 'Tag', 'EditTextVhyst1'),'UserData',Vhyst1);			%[m^3] Volume
   set(findobj(gcf, 'Tag', 'EditTextmhyst1'),'UserData',mhyst1);			%[kg] mass
   set(findobj(gcf, 'Tag', 'EditTextmhyst1'),'String',sprintf('%0.4g',mhyst1*1000));	%[g] mass 
   set(findobj(gcf, 'Tag', 'EditTextMhyst1'),'UserData',Mhyst1);			%[A.m^2] Magnetic moment
   set(findobj(gcf, 'Tag', 'EditTextMhyst1'),'String',sprintf('%0.4g',Mhyst1));		%[A.m^2] Magnetic moment
   
elseif strcmp(action, 'setMhyst1')
   %global uo SGhymu
   Mhyst1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextMhyst1'),'String'), '%f');		%[A.m^2] Magnetic moment
   Bs1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextBs1'),'String'), '%f');		%[Tesla] Magnetic induction (field strength)
   ...
   set(findobj(gcf, 'Tag', 'EditTextmhyst1'),'String',sprintf('%0.4g',mhyst1*1000));	%[g] mass 
   set(findobj(gcf, 'Tag', 'EditTextVhyst1'),'UserData',Vhyst1);			%[m^3] Volume
   set(findobj(gcf, 'Tag', 'EditTextVhyst1'),'String',sprintf('%0.4g',Vhyst1*1e+6));	%[cm^3] Volume  
   
elseif strcmp(action, 'setmhyst1')
   %global uo SGhymu
   mhyst1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextmhyst1'),'String'), '%f')/1000;	%[kg] mass
   Bs1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextBs1'),'String'), '%f');		%[Tesla] Magnetic induction (field strength)
...
elseif strcmp(action, 'setVhyst2')
   %global uo SGhymu
   Vhyst2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextVhyst2'),'String'), '%f')*1e-6;	%[m^3] Volume
   Bs2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextBs2'),'String'), '%f');		%[Tesla] Magnetic induction (field strength)
   Mhyst2 = Bs2 * Vhyst2 / uo;							%[A.m^2] Magnetic moment
   mhyst2 = Vhyst2 * (SGhymu * 1000);							%[kg] mass
   set(findobj(gcf, 'Tag', 'EditTextVhyst2'),'UserData',Vhyst2);			%[m^3] Volume
   set(findobj(gcf, 'Tag', 'EditTextmhyst2'),'UserData',mhyst2);			%[kg] mass
   set(findobj(gcf, 'Tag', 'EditTextmhyst2'),'String',sprintf('%0.4g',mhyst2*1000));	%[g] mass 
   set(findobj(gcf, 'Tag', 'EditTextMhyst2'),'UserData',Mhyst2);			%[A.m^2] Magnetic moment
   set(findobj(gcf, 'Tag', 'EditTextMhyst2'),'String',sprintf('%0.4g',Mhyst2));		%[A.m^2] Magnetic moment
   
elseif strcmp(action, 'setMhyst2')
   %global uo SGhymu
   Mhyst2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextMhyst2'),'String'), '%f');		%[A.m^2] Magnetic moment
   Bs2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextBs2'),'String'), '%f');		%[Tesla] Magnetic induction (field strength)
   ...
   set(findobj(gcf, 'Tag', 'EditTextmhyst2'),'String',sprintf('%0.4g',mhyst2*1000));	%[g] mass 
   set(findobj(gcf, 'Tag', 'EditTextVhyst2'),'UserData',Vhyst2);			%[m^3] Volume
   set(findobj(gcf, 'Tag', 'EditTextVhyst2'),'String',sprintf('%0.4g',Vhyst2*1e+6));	%[cm^3] Volume  
   
elseif strcmp(action, 'setmhyst2')
   %global uo SGhymu
   mhyst2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextmhyst2'),'String'), '%f')/1000;	%[kg] mass
   Bs2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextBs2'),'String'), '%f');		%[Tesla] Magnetic induction (field strength)
...
elseif strcmp(action, 'eval')|strcmp(action, 'run')
   ...
   %global fs
   sim_last = get(findobj(gcf, 'Tag', 'EditTextLast'),'UserData');	        	%[sec]
   sim_dur = get(findobj(gcf, 'Tag', 'EditTextDur'),'UserData');                    	%[rev]
   sim_sample =  sscanf(get(findobj(gcf, 'Tag', 'EditTextSample'),'String'), '%f');	%[]
   fs = get(findobj(gcf, 'Tag', 'EditTextfs'),'UserData');        	        	%[s]
   Ts = get(findobj(gcf, 'Tag', 'EditTextTs'),'UserData'); 	                	%[s]
   
   % === Orbit ===
   EYear = mod(sscanf(get(findobj(gcf, 'Tag', 'EditTextYear'),'String'), '%f'),2000); 	%[year2000]
   Epoch = sscanf(get(findobj(gcf, 'Tag', 'EditTextEpoch'),'String'), '%f');     	%[day]
   incl = sscanf(get(findobj(gcf, 'Tag', 'EditTextIncl'),'String'), '%f')*pi/180;	%[rad]
   raan = sscanf(get(findobj(gcf, 'Tag', 'EditTextRAAN'),'String'), '%f')*pi/180;	%[rad]
   e = sscanf(get(findobj(gcf, 'Tag', 'EditTextEcc'),'String'), '%f');     	%[]
   argp = sscanf(get(findobj(gcf, 'Tag', 'EditTextARGP'),'String'), '%f')*pi/180;	%[rad]
   Msc0 = sscanf(get(findobj(gcf, 'Tag', 'EditTextMsc0'),'String'), '%f')*pi/180;	%[rad]
   n = get(findobj(gcf, 'Tag', 'EditTextn'),'UserData'); 		            	%[rev/day]
   h = get(findobj(gcf, 'Tag', 'EditTexth'),'UserData');		             	%[km]
   ...
   Iyz = sscanf(get(findobj(gcf, 'Tag', 'EditTextIyz'),'String'), '%f')*1e-6;           %[kg.m²] product of inerti
   Isc = [Ixx Ixy Ixz; Ixy Iyy Iyz; Ixz Iyz Izz];                                 	%[kg.m²] Moment of inertia tensor
   Jinv = Isc^(-1);									% Inverse of tensor   msc = sscanf(get(findobj(gcf, 'Tag', 'EditTextmsc'),'String'), '%f');           	%[kg] mass
   msc = sscanf(get(findobj(gcf, 'Tag', 'EditTextmsc'),'String'), '%f');           	%[kg] total S/C mass
   side = sscanf(get(findobj(gcf, 'Tag', 'EditTextcsc'),'String'), '%f');           	%[m] base width
   lsc = sscanf(get(findobj(gcf, 'Tag', 'EditTextlsc'),'String'), '%f');		%[m] length
   A1sc = side^2;									%[m^2] base face area
   A2sc = side*lsc;									%[m^2] long face area
   wallsc = sscanf(get(findobj(gcf, 'Tag', 'EditTextwallsc'),'String'), '%f')/1000;	%[m]
   Cd = get(findobj(gcf, 'Tag', 'EditTextCd'),'UserData');              		%[] Drag coef
   Cb = get(findobj(gcf, 'Tag', 'EditTextCb'),'UserData');              		%[] Ballistic coef
   PVeff = sscanf(get(findobj(gcf, 'Tag', 'EditTextPVeff'),'String'), '%f')/100;   	%[] Solar cells efficiency
   PVpack1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextPVpack1'),'String'), '%f')/100;	%[] packing on base
   PVpack2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextPVpack2'),'String'), '%f')/100;	%[] packing on sides
   
   Qin = sscanf(get(findobj(gcf, 'Tag', 'EditTextQin'),'String'), '%f');
   ...
   %wspin = sscanf(get(findobj(gcf, 'Tag', 'EditTextwspin'),'String'), '%f')*pi/180; 	%[]
   %inclbody = sscanf(get(findobj(gcf, 'Tag', 'EditTextibody'),'String'), '%f')*pi/180;	%[]
   %wbody = sscanf(get(findobj(gcf, 'Tag', 'EditTextwbody'),'String'), '%f')*pi/180;   	%[]
   
   Bmag = sscanf(get(findobj(gcf, 'Tag', 'EditTextBmag'),'String'), '%f');	%[Tesla] Magnetic induction (saturation field strength)
   Vmag = get(findobj(gcf, 'Tag', 'EditTextVmag'),'UserData');			%[m^3] Volume 
   umagx = sscanf(get(findobj(gcf, 'Tag', 'EditTextumagx'),'String'), '%f');	%[] Orientation in Body-frame components
   umagy = sscanf(get(findobj(gcf, 'Tag', 'EditTextumagy'),'String'), '%f');	%[] Orientation in Body-frame components
   umagz = sscanf(get(findobj(gcf, 'Tag', 'EditTextumagz'),'String'), '%f');	%[] Orientation in Body-frame components
   umag = [umagx; umagy ; umagz]./ norm([umagx; umagy ; umagz]);		%normalized   
   mmag = sscanf(get(findobj(gcf, 'Tag', 'EditTextmmag'),'String'), '%f')/1000;	%[kg] mass
 
   
   Bs1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextBs1'),'String'), '%f');	%[Tesla] Magnetic induction (saturation field strength)
   Vhyst1 = get(findobj(gcf, 'Tag', 'EditTextVhyst1'),'UserData');		%[m^3] Volume
   uhyst1x = sscanf(get(findobj(gcf, 'Tag', 'EditTextuhyst1x'),'String'), '%f');	%[] Orientation in Body-frame components
   uhyst1y = sscanf(get(findobj(gcf, 'Tag', 'EditTextuhyst1y'),'String'), '%f');	%[] Orientation in Body-frame components
   uhyst1z = sscanf(get(findobj(gcf, 'Tag', 'EditTextuhyst1z'),'String'), '%f');	%[] Orientation in Body-frame components
   uhyst1 = [uhyst1x; uhyst1y; uhyst1z]./ norm([uhyst1x; uhyst1y; uhyst1z]);		%normalized   
   mhyst1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextmhyst1'),'String'), '%f')/1000;	%[kg] mass
   
   Bs2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextBs2'),'String'), '%f');	%[Tesla] Magnetic induction (saturation field strength)
   Vhyst2 = get(findobj(gcf, 'Tag', 'EditTextVhyst2'),'UserData');		%[m^3] Volume
   uhyst2x = sscanf(get(findobj(gcf, 'Tag', 'EditTextuhyst2x'),'String'), '%f');	%[] Orientation in Body-frame components
   uhyst2y = sscanf(get(findobj(gcf, 'Tag', 'EditTextuhyst2y'),'String'), '%f');	%[] Orientation in Body-frame components
   uhyst2z = sscanf(get(findobj(gcf, 'Tag', 'EditTextuhyst2z'),'String'), '%f');	%[] Orientation in Body-frame components
   uhyst2 = [uhyst2x; uhyst2y; uhyst2z]./ norm([uhyst2x; uhyst2y; uhyst2z]);		%normalized   
   mhyst2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextmhyst2'),'String'), '%f')/1000;	%[kg] mass
   
   Br = 0.35;	%Remanence induction
   Hc = 1.59; 	%Coercive field
   sw = get(findobj(gcf, 'Tag', 'ButtonSW1'),'UserData');	%Hysteresis model switch {1=delay+ramp Br/H,   2=delay+ramp Bs/2H,   3=delay only}
   ...
   % === Ground Stations ===   
   NAME_GS1 = get(findobj(gcf, 'Tag', 'EditTextGS1'),'String');                       	%[] 
   LON_GS1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextGS1lon'),'String'), '%f')*pi/180;	%[rad]
   LAT_GS1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextGS1lat'),'String'), '%f')*pi/180;	%[rad]
   MEL_GS1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextGS1el'),'String'), '%f')*pi/180;	%[rad]
   f1 = sscanf(get(findobj(gcf, 'Tag', 'EditTextGS1fq'),'String'), '%f')*1000000;     	%[Hz]
   
   NAME_GS2 = get(findobj(gcf, 'Tag', 'EditTextGS2'),'String');                        	%[]
   LON_GS2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextGS2lon'),'String'), '%f')*pi/180;	%[rad]
   LAT_GS2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextGS2lat'),'String'), '%f')*pi/180;	%[rad]
   MEL_GS2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextGS2el'),'String'), '%f')*pi/180;	%[rad]
   f2 = sscanf(get(findobj(gcf, 'Tag', 'EditTextGS2fq'),'String'), '%f')*1000000;     	%[Hz]
   
   NAME_GS3 = get(findobj(gcf, 'Tag', 'EditTextGS3'),'String');                        	%[]
   LON_GS3 = sscanf(get(findobj(gcf, 'Tag', 'EditTextGS3lon'),'String'), '%f')*pi/180;	%[rad]
   LAT_GS3 = sscanf(get(findobj(gcf, 'Tag', 'EditTextGS3lat'),'String'), '%f')*pi/180;	%[rad]
   MEL_GS3 = sscanf(get(findobj(gcf, 'Tag', 'EditTextGS3el'),'String'), '%f')*pi/180;	%[rad]
   f3 = sscanf(get(findobj(gcf, 'Tag', 'EditTextGS3fq'),'String'), '%f')*1000000;     	%[Hz]
   ...
   Eclipse_min = asin(sqrt( (Re/ra)^2 - (sin(i))^2 ))/pi * Psc;	%[s]
   ...
   %Air Drag
   [rhoa, ScaleHt, rhoa_max, rhoa_min] = getAtmDensity(h); %[kg/m³], [km]  !warning, dimentions are not consistent

   adrag = -0.5*rhoa/Cb*(Vp*1000)^2; 		%[m/s^2]
   Drag = adrag*msc;                         	%[N]
   Decay = adrag/(2*pi*a*1000)*(Te^2);       	%[rev/day^2]
   ...
   Decay_max = adrag_max/(2*pi*a*1000)*(Te^2);       	%[rev/day^2]
   ...
   Decay_min = adrag_min/(2*pi*a*1000)*(Te^2);       	%[rev/day^2]
   ...
   % Text Fields Update
   %============================================================
   set(findobj(gcf, 'Tag', 'EditTextDecay'),'String',sprintf('%0.2g',-Decay));
   set(findobj(gcf, 'Tag', 'EditTexta'),'String',sprintf('%0.5g',a));
   %set(findobj(gcf, 'Tag', 'EditTextb'),'String',sprintf('%0.5g',b));
   %set(findobj(gcf, 'Tag', 'EditTextc'),'String',sprintf('%0.5g',c));
   set(findobj(gcf, 'Tag', 'EditTextra'),'String',sprintf('%0.5g',ra));
   set(findobj(gcf, 'Tag', 'EditTextrp'),'String',sprintf('%0.5g',rp));
   set(findobj(gcf, 'Tag', 'EditTextVa'),'String',sprintf('%0.5g',Va));
   set(findobj(gcf, 'Tag', 'EditTextVp'),'String',sprintf('%0.5g',Vp));
   set(findobj(gcf, 'Tag', 'EditTextEclmax'),'String',sprintf('%0.5g',Eclipse_max/60));
   set(findobj(gcf, 'Tag', 'EditTextEclmin'),'String',sprintf('%0.5g',Eclipse_min/60));
   set(findobj(gcf, 'Tag', 'EditTextPsc'),'String',sprintf('%0.5g',Psc/60));
   set(findobj(gcf, 'Tag', 'EditTextdLON'),'String',sprintf('%0.5g',dLON*180/pi));
   set(findobj(gcf, 'Tag', 'EditTextDraan'),'String',sprintf('%0.5g',Draan*Te*180/pi));
   set(findobj(gcf, 'Tag', 'EditTextDargp'),'String',sprintf('%0.4g',Dargp*Te*180/pi));
   set(findobj(gcf, 'Tag', 'EditTextDrag'),'String',sprintf('%0.5g',-Drag*1e+9));
   set(findobj(gcf, 'Tag', 'EditTextDecay2'),'String',sprintf('%0.1g',-Da_rev/Psc*Psun));
   set(findobj(gcf, 'Tag', 'EditTextLife'),'String',sprintf('%3.0f',OrbitLife));
   set(findobj(gcf, 'Tag', 'EditTextStabRes'),'String',sprintf('%0.4g',Stab_res*180/pi));
   
   save cubesim/current.mat 
   
   fprintf('Parameters updated and saved.\n')
   LocalDisplay('Parameters updated and saved.', 'nl')
   ...
   if strcmp(action, 'run')
      ...
      % Position of sun resolven in ecliptic and Earth referentials
      ...
      for i=1:sim_sample
         ROTecl_geo = Rz(GST(i))*Rx(-incle);
         XYZsun_geo(:,i) = ROTecl_geo * XYZsun_ecl(:,i);
      end
      ...
      for i=1:N_GS
         LLgs_cir0(2*i-1:2*i,:) = identSC([LON_GS(i);LAT_GS(i)], [circle; 0*circle], S_maxp_V);			%[rad]
         LLgs_cirMEL(2*i-1:2*i,:) = identSC([LON_GS(i);LAT_GS(i)], [circle; MEL_GS(i)*ones(1,length(circle))], SR_GS_V(i,:));	%[rad]
      end
      ...
      for i=1:sim_sample
         ROTinertial_geo = Rz(we*t_VE(i))*Rx(incle);
         XYZfield_I(:,i) = ROTinertial_geo^(-1) * XYZfield_geo(:,i);
      end
      XYZfield_I;
      ...
      for i=1:sim_sample
         ROTbody_I = [Xbody_I(:,i), Ybody_I(:,i), Zbody_I(:,i)];
         umag_I(:,i) = ROTbody_I * umag;
      end
      ...
      for i=1:sim_sample
         ROTinertial_geo = Rz(we*t_VE(i))*Rx(incle);
         Xbody_geo(:,i) = ROTinertial_geo * Xbody_I(:,i);
         Ybody_geo(:,i) = ROTinertial_geo * Ybody_I(:,i);
         Zbody_geo(:,i) = ROTinertial_geo * Zbody_I(:,i);
         umag_geo(:,i) = ROTinertial_geo * umag_I(:,i);
      end
      ...
      for i=1:N_GS
         XYZgs_geo(3*i-2:3*i,:) = LL2XYZ([LON_GS(i); LAT_GS(i)]) * Re;
         XYZgs_cir0_geo(3*i-2:3*i,:) = LL2XYZ(LLgs_cir0(2*i-1:2*i,:)) * Re;
         XYZgs_cirMEL_geo(3*i-2:3*i,:) = LL2XYZ(LLgs_cirMEL(2*i-1:2*i,:)) * Re;
      end
      ...
      for i=1:sim_sample
         ROTecl_geo = Rz(GST(i))*Rx(-incle);
         XYZzero_sun(:,i) = (ROTecl_geo' * XYZzero_geo) + XYZgeo_sun(:,i);
         XYZsc_sun(:,i) = (ROTecl_geo' * XYZsc_geo(:,i)) + XYZgeo_sun(:,i);
      end
      ...
      for i=1:N_GS
         %G/S tracking data
         [AziEl_GSi, Range_GSi, XYZgs2sc_i] = trackSC([LON_GS(i); LAT_GS(i)], [LONsc; LATsc], Rsc, filter);
         Azimut_GS(i,:) = AziEl_GSi(1,:);
         Elevation_GS(i,:) = AziEl_GSi(2,:);
         Range_GS(i,:) = Range_GSi;
         
         %S/C antenna magnetic pointing error to ground station location
         %[AGLgs2ant_i, Rgs2ant_i] = getPtError([LON_GS(i); LAT_GS(i)], LLmagpt, Rmagpt, Range_GSi);
         [AGLgs2ant_i, Rgs2ant_i] = getPtError([LON_GS(i); LAT_GS(i)], LLattpt, Rattpt, Range_GSi);
         AGLgs2ant(i,:) = AGLgs2ant_i;
         Rgs2ant(i,:) = Rgs2ant_i;
         
         %Link Doppler shift
         [Doppler_i, DpRate_i] = getDoppler(XYZgs2sc_i, fs, f0(i));
         Doppler_GS(i,:) = Doppler_i;
         DpRate_GS(i,:) = DpRate_i;
         % filter for LOS data only
         for j=1:sim_sample
            if Elevation_GS(i,j) >= 0
            else
               Doppler_GS(i,j) = NaN;
               DpRate_GS(i,j) = NaN;
            end
      ...
      for i=1:N_GS
         [tLink_GSi, Pass_GSi, Link_state(i,:), Link_GSi] = ...
            getLink(Elevation_GS(i,:), MEL_GS(i), Ts, AGLgs2ant(i,:), Beam);
         
         tLink_GS(i,:) = tLink_GSi(1:10);
         Pass_GS(i,:) = Pass_GSi(1:10);
         Link_GS(i,:) = Link_GSi(1:10);         
         
         for j=1:length(Link_GSi)
            LinkT_GS(i) = LinkT_GS(i) + Link_GSi(j);
         end
         
         for j=1:length(Pass_GSi)
            PassT_GS(i) = PassT_GS(i) + Pass_GSi(j);
         end         
      end
      ...
      EclipseT = 0;
      for i=1:length(Eclipse_approx)
         EclipseT = EclipseT + Eclipse(i);  %sum of all eclipse times
      end
      ...
      for j=1:6
         ...
         for i=1:sim_sample
            Obody_sun(j,i) = min(Obody_sun(j,i), pi/2);		% Back side of face is not exposed (angle>90°)
         end
      end
      ...
      for j=1:6
         ...
         for i=1:sim_sample
            Obody_geo_F(j,i) = Obody_geo(j,i);
            %Obody_geo_F(j,i) = min(Obody_geo_F(j,i), pi/2+rho_earth(i));
            Obody_geo(j,i) = max(Obody_geo(j,i)-rho_earth(i), 0);   	% Front side of face is fully exposed (angle<0°)
            Obody_geo(j,i) = min(Obody_geo(j,i)-rho_earth(i), pi/2);	% Back side of face is not exposed (angle>90°)
         end
      end
      ...
      VFearth0 = (1-[1;1;1;1;1;1]*cos(rho_earth));
      VFearth = VFearth0 .* 0.5.*(1+ cos(max(min(pi/2./([1;1;1;1;1;1]*rho_earth).*(Obody_geo_F+([1;1;1;1;1;1]*rho_earth)-pi/2),pi),0)));
      ...
      for j=1:6
         ...
         for i=1:sim_sample   
            Obody_geo_max(j,i) = acos(dot(Nbody(3*j-2:3*j,1), -([1; 1; 1]./sqrt(3)) ));
            Obody_geo_max(j,i) = max(Obody_geo_max(j,i), 0);   		% Front side of face is fully exposed (angle<0°)
            Obody_geo_max(j,i) = min(Obody_geo_max(j,i), pi/2);		% Back side of face is not exposed (angle>90°)
         end
      end
      ...
      for j=1:6
         for i=1:sim_sample
            Obody_geo_min(j,i) = acos( dot( Nbody(3*j-2:3*j,1), -([0; 0; 1]) ));
            Obody_geo_min(j,i) = max(Obody_geo_min(j,i), 0);   		% Front side of face is fully exposed (angle<0°)
            Obody_geo_min(j,i) = min(Obody_geo_min(j,i), pi/2);		% Back side of face is not exposed (angle>90°)
         end
      end
      ...
      for j=1:6
         for i=1:sim_sample
            Obody_geo_min2(j,i) = acos( dot( Nbody(3*j-2:3*j,1), -([cos(rho_earth(i)); sin(rho_earth(i)); 0]) ));
            Obody_geo_min2(j,i) = max(Obody_geo_min2(j,i), 0);   		% Front side of face is fully exposed (angle<0°)
            Obody_geo_min2(j,i) = min(Obody_geo_min2(j,i), pi/2);		% Back side of face is not exposed (angle>90°)
         end
      end
      ...
      % --- Earth IR ---
      rho_earth0 = asin(Re/(Re+h));   	%[rad]
      Fearth0 = (1-cos(rho_earth0))/2;	%[]
      q_earth0 = Fearth0*GIR*emi;  	%[W/m²]
      
      % --- Sun ---
      q_sun0 = Gsolar_max*absorb;        	%[W/m²]
      
      % --- Sun Albedo ---
      Ka0 = 0.664+0.521*rho_earth0-0.203*rho_earth0^2;   	%[]
      q_albedo0 = Fearth0*Albedo*Gsolar_max*Ka0*absorb;	%[W/m²]
      
      % --- Cube in space with ideal conductivity ---
      Qearth1 = 3*A1sc*q_earth0;     		%[W]
      ...
      if get(findobj(gcf,'Tag','CheckBoxTempSim'),'Value')
         ...
         for i=1:sim_sample
            j=find(t2>=t(i));
            T2i = T2(j(1),1);
            q_radspace2(:,i) = (Boltzmann .* emi_wall ) * (T2i.^4 - 4^4);
         end
         ...
         for i=1:sim_sample
            j=find(t7>=t(i));
            T7i = T7(j(1),1);
            q_radspace7(:,i) = (Boltzmann .* emi_wall ) * (T7i.^4 - 4^4);
         end
      ...
      DataStr0={'CUBESAT ORBIT SIMULATION RESULTS';
         ...
         sprintf('  Orbit decay rate min       	%0.5g [rev/day²]',Decay_min);
         sprintf('  Orbit decay rate max       	%0.5g [rev/day²]',Decay_max);
      ...
      set(findobj(gcf,'Tag','ButtonHistory'),'UserData',DataStr);
      ...
      if get(findobj(gcf,'Tag','CheckBoxPlot2D'),'Value')
         %============================================================
         % Orbit Shape Plot
         %============================================================
         fprintf('*')
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotOrbShape', 'Type', 'axes'))
         ...
         delete(findobj(gcf,'Tag','PlotOrbShapeLeg', 'Type', 'axes'))
         set(H, 'Tag', 'PlotOrbShapeLeg', 'UserData', 'Graph');                            
         set(get(H, 'Children'), 'Tag', 'PlotOrbShapeLeg', 'UserData', 'Graph');       
         ...
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotTrkAngle', 'Type', 'axes'))
         for i=1:N_GS
            H = plotTrace(180/pi*LONsc, 180/pi*Azimut_GS(i,:),'--');
            set(H, 'Tag', 'PlotTrkAngle', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
            H = plotTrace(180/pi*LONsc, 180/pi*Elevation_GS(i,:),'.');
            set(H, 'Tag', 'PlotTrkAngle', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
         %   H = plotTrace(180/pi*LONsc, 180/pi*AGLgs2ant(i,:),'-');
         %   set(H, 'Tag', 'PlotTrkAngle', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
         end
         plot(circle*180/pi, zeros(size(circle)), 'k+','Tag', 'PlotTrkAngle', 'UserData', 'Graph');
         delete(findobj(gcf,'Tag','PlotTrkAngleLeg', 'Type', 'axes'));
         H = legend(...
         ...
         set(H, 'Tag', 'PlotTrkAngleLeg', 'UserData', 'Graph');
         set(get(H, 'Children'), 'Tag', 'PlotTrkAngleLeg', 'UserData', 'Graph');                            
         
         
         % === Plot tracking ranges ===          
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotTrkRange', 'Type', 'axes'))
         plot(circle*180/pi, S_maxa*ones(size(circle)), 'k+', circle*180/pi, S_minp*ones(size(circle)), 'k--',...
            'Tag', 'PlotTrkRange', 'UserData', 'Graph');
         for i=1:N_GS
            H = plotTrace(180/pi*LONsc, Range_GS(i,:),'.-');
            set(H, 'Tag', 'PlotTrkRange', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
         %   H = plotTrace(180/pi*LONsc, Rgs2ant(i,:),'--');
         %   set(H, 'Tag', 'PlotTrkRange', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
         end
         str_range1 = sprintf('Slant range = %0.5gkm',S_maxa);
         str_range2 = sprintf('Azimut range = %0.5gkm',S_minp);
         delete(findobj(gcf,'Tag','PlotTrkRangeLeg', 'Type', 'axes'));
         ...
         set(H, 'Tag', 'PlotTrkRangeLeg', 'UserData', 'Graph');                            
         set(get(H, 'Children'), 'Tag', 'PlotTrkRangeLeg', 'UserData', 'Graph');                            
         
         
         % === Plot doppler shift data ===
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotTrkDoppler', 'Type', 'axes'))
         %plot(circle*180/pi, S_maxp*ones(size(circle)), 'k+', circle*180/pi, S_minp*ones(size(circle)), 'k--')
         for i=1:N_GS
            H = plotTrace(180/pi*LONsc, Doppler_GS(i,:)./1000,'-');
            set(H, 'Tag','PlotTrkDoppler', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
         end
         delete(findobj(gcf,'Tag','PlotTrkDopplerLeg', 'Type', 'axes'));
         H = legend(['Doppler shift ', NAME_GS(1,:)],['Doppler shift ', NAME_GS(2,:)],['Doppler shift ', NAME_GS(3,:)]);
         set(H, 'Tag', 'PlotTrkDopplerLeg', 'UserData', 'Graph');    
         set(get(H, 'Children'), 'Tag', 'PlotTrkDopplerLeg', 'UserData', 'Graph');                            
         
         
         % === Plot angular tracking data ===
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotTrkAngleTime', 'Type', 'axes'))
         for i=1:N_GS
            H = plot(t./60, 180/pi*Azimut_GS(i,:),'--');
            set(H, 'Tag', 'PlotTrkAngleTime', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
            H = plot(t./60, 180/pi*Elevation_GS(i,:),'.');
            set(H, 'Tag', 'PlotTrkAngleTime', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
         %   H = plot(t./60, 180/pi*AGLgs2ant(i,:),'-');
         %   set(H, 'Tag', 'PlotTrkAngleTime', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 1-(i-1)/max(1,(N_GS-1)) 1]);
         end
         plot([0 t(sim_sample)/60], [0 0], 'k+--','Tag', 'PlotTrkAngleTime', 'UserData', 'Graph');
         delete(findobj(gcf,'Tag','PlotTrkAngleTimeLeg', 'Type', 'axes'));
         H = legend(...
            ['G/S Azimut ', NAME_GS(1,:)],['G/S Elevation ', NAME_GS(1,:)],...
            ['G/S Azimut ', NAME_GS(2,:)],['G/S Elevation ', NAME_GS(2,:)],...
            ['G/S Azimut ', NAME_GS(3,:)],['G/S Elevation ', NAME_GS(3,:)]);
         ...
         %   ['G/S Azimut ', NAME_GS(2,:)],['G/S Elevation ', NAME_GS(2,:)],['Mag pointing deviation ', NAME_GS(2,:)],...
         %   ['G/S Azimut ', NAME_GS(3,:)],['G/S Elevation ', NAME_GS(3,:)],['Mag pointing deviation ', NAME_GS(3,:)]);
         set(H, 'Tag', 'PlotTrkAngleTimeLeg', 'UserData', 'Graph');
         set(get(H, 'Children'), 'Tag', 'PlotTrkAngleTimeLeg', 'UserData', 'Graph');                            
         
         
         % === Plot tracking ranges ===          
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotTrkRangeTime', 'Type', 'axes'))
         plot([t(1) t(sim_sample)]/60, S_maxa*[1 1], 'k+--', [t(1) t(sim_sample)]/60, S_minp*[1 1], 'k.--',...
            'Tag', 'PlotTrkRangeTime', 'UserData', 'Graph');
         for i=1:N_GS
            H = plot(t./60, Range_GS(i,:),'.-');
            set(H, 'Tag', 'PlotTrkRangeTime', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
         %   H = plot(t./60, Rgs2ant(i,:),'--');
         %   set(H, 'Tag', 'PlotTrkRangeTime', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 1-(i-1)/max(1,(N_GS-1)) 0.5]);
         end
         str_range1 = sprintf('Slant range = %0.5gkm',S_maxa);
         str_range2 = sprintf('Azimut range = %0.5gkm',S_minp);
         delete(findobj(gcf,'Tag','PlotTrkRangeTimeLeg', 'Type', 'axes'));
         H = legend(str_range1, str_range2,...
             ['G/S link range ', NAME_GS(1,:)], ['G/S link range ', NAME_GS(2,:)],['G/S link range ', NAME_GS(3,:)]);
         %   ['G/S link range ', NAME_GS(1,:)], ['Mag pointing gnd deviation ', NAME_GS(1,:)],...
         %   ['G/S link range ', NAME_GS(2,:)], ['Mag pointing gnd deviation ', NAME_GS(2,:)],...
         %   ['G/S link range ', NAME_GS(3,:)], ['Mag pointing gnd deviation ', NAME_GS(3,:)]);
         set(H, 'Tag', 'PlotTrkRangeTimeLeg', 'UserData', 'Graph');                            
         set(get(H, 'Children'), 'Tag', 'PlotTrkRangeTimeLeg', 'UserData', 'Graph');                            
         
         
         % === Plot doppler shift data ===
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotTrkDopplerTime', 'Type', 'axes'))
         %plot(circle*180/pi, S_maxp*ones(size(circle)), 'k+', circle*180/pi, S_minp*ones(size(circle)), 'k--')
         for i=1:N_GS
            H = plot(t./60, Doppler_GS(i,:)./1000,'-');
            set(H, 'Tag','PlotTrkDopplerTime', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
         end
         delete(findobj(gcf,'Tag','PlotTrkDopplerTimeLeg', 'Type', 'axes'));
         H = legend(['Doppler shift ', NAME_GS(1,:)],['Doppler shift ', NAME_GS(2,:)],['Doppler shift ', NAME_GS(3,:)]);
         set(H, 'Tag', 'PlotTrkDopplerTimeLeg', 'UserData', 'Graph');    
         set(get(H, 'Children'), 'Tag', 'PlotTrkDopplerTimeLeg', 'UserData', 'Graph'); 
         ...
         % === Radiation Area ===
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotRadArea', 'Type', 'axes'))
         ...
         delete(findobj(gcf,'Tag','PlotRadAreaLeg', 'Type', 'axes'));
         H = legend('Earth (disk)', 'Sun (point)', 'Space',...
            ['Total S/C area ', sprintf('%0.2gm²', 2*A1sc+4*A2sc)], 'Eclispe state (1/20)');      
         set(H, 'Tag', 'PlotRadAreaLeg', 'UserData', 'Graph');    
         set(get(H, 'Children'), 'Tag', 'PlotRadAreaLeg', 'UserData', 'Graph');     
         
         
         % === Radiation Power ===
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotRadPower', 'Type', 'axes'))
         ...
         delete(findobj(gcf,'Tag','PlotRadPowerLeg', 'Type', 'axes'));
         H = legend('Earth IR', 'Sun', 'Sun Albedo', 'Total', 'Eclispe state');
         set(H, 'Tag', 'PlotRadPowerLeg', 'UserData', 'Graph');    
         set(get(H, 'Children'), 'Tag', 'PlotRadPowerLeg', 'UserData', 'Graph');       
         
         if get(findobj(gcf,'Tag','CheckBoxTempSim'),'Value')
            % === Radiation Energy, 2-DOF Model ===
            LocalDisplay('*', 'add')
            subplot(findobj(gcf,'Tag','PlotRadInput2', 'Type', 'axes'))
            %for i=1:1
            %   H = plot(t./60, Qface(i,:), 'r-', 'Tag', 'PlotRadInput2, 'UserData', 'Graph');
            %   set(H, 'color', [(i-1)/max(1,(6-1)) 1-(i-1)/max(1,(6-1)) 0.5]);
            %end
            ...
            delete(findobj(gcf,'Tag','PlotRadInput2Leg', 'Type', 'axes'));
            H = legend('Earth IR', 'Sun', 'Sun Albedo', 'Space', 'Total (computed)', 'Total (ODE sim)');%,'Nominal IR', 'Nominal Sun', 'Nominal Albedo')%, 'Eclipse State');
            set(H, 'Tag', 'PlotRadInput2Leg', 'UserData', 'Graph');    
            set(get(H, 'Children'), 'Tag', 'PlotRadInput2Leg', 'UserData', 'Graph');       
            
            
            % === Radiation Temperature, 2-DOF Model ===
            LocalDisplay('*', 'add')
            subplot(findobj(gcf,'Tag','PlotRadTemp2', 'Type', 'axes'))
            ...
            delete(findobj(gcf,'Tag','PlotRadTemp2Leg', 'Type', 'axes'));
            H = legend('Faces temperature', 'Internal temperature', 'Eclispe state (100x)');
            set(H, 'Tag', 'PlotRadTemp2Leg', 'UserData', 'Graph');    
            set(get(H, 'Children'), 'Tag', 'PlotRadTemp2Leg', 'UserData', 'Graph');       
            
            
            % === Radiation Energy, 7-DOF Model ===      
            LocalDisplay('*', 'add')
            subplot(findobj(gcf,'Tag','PlotRadInput7', 'Type', 'axes'))
            %for i=1:6
            %   H = plot(t./60, Qface(i,:), 'r-', 'Tag', 'PlotRadInput7', 'UserData', 'Graph');
            %   set(H, 'color', [(i-1)/max(1,(6-1)) 1-(i-1)/max(1,(6-1)) 0.5]);
            %end
            ...
            %axis([0 120 -20 20])
            delete(findobj(gcf,'Tag','PlotRadInput7Leg', 'Type', 'axes'));
            H = legend('Earth IR', 'Sun', 'Sun Albedo', 'Space', 'Total (computed)', 'Total (ODE sim)');%, 'Eclipse State');
            set(H, 'Tag', 'PlotRadInput7Leg', 'UserData', 'Graph');    
            set(get(H, 'Children'), 'Tag', 'PlotRadInput7Leg', 'UserData', 'Graph');  
            
            
            % === Radiation Temperature, 7-DOF Model ===      
            LocalDisplay('*', 'add')
            subplot(findobj(gcf,'Tag','PlotRadTemp7', 'Type', 'axes'))
            for i=1:6
               H = plot(t7./60, T7(:,i)-273, 'r-', 'Tag', 'PlotRadTemp7', 'UserData', 'Graph');
               set(H, 'color', [(i-1)/max(1,(6-1)) 1-(i-1)/max(1,(6-1)) 0.5]);
            end
            ...
            delete(findobj(gcf,'Tag','PlotRadTemp7Leg', 'Type', 'axes'));
            H = legend('Face 1', 'Face 2', 'Face 3', 'Face 4', 'Face 5', 'Face 6',...
               'Internal', 'Eclispe state (100x)');
            set(H, 'Tag', 'PlotRadTemp7Leg', 'UserData', 'Graph');    
            set(get(H, 'Children'), 'Tag', 'PlotRadTemp7Leg', 'UserData', 'Graph');   
         ...
         % === Angle to field ===
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotMagSim', 'Type', 'axes'))
         %hold on;
         ...
         delete(findobj(gcf,'Tag','PlotMagSimLeg', 'Type', 'axes'));
         H = legend('Field-Nadir angle', 'System resolution', 'Magnet-Nadir angle','Magnet-Field angle');
         set(H, 'Tag', 'PlotMagSimLeg', 'UserData', 'Graph');    
         set(get(H, 'Children'), 'Tag', 'PlotMagSimLeg', 'UserData', 'Graph');       
                    
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotMagSimTime', 'Type', 'axes'))
         %hold on;
         ...
         delete(findobj(gcf,'Tag','PlotMagSimTimeLeg', 'Type', 'axes'));
         H = legend('Field-Nadir angle', 'System resolution', 'Magnet-Nadir angle','Magnet-Field angle');
         set(H, 'Tag', 'PlotMagSimTimeLeg', 'UserData', 'Graph');    
         set(get(H, 'Children'), 'Tag', 'PlotMagSimTimeLeg', 'UserData', 'Graph');       
         
         % === Angular rate ===
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotRateTime', 'Type', 'axes'))
         %hold on;
         ...
         delete(findobj(gcf,'Tag','PlotRateTimeLeg', 'Type', 'axes'));
         H = legend('Total angular rate', 'Angular rate about magnet axis (nutation)');
         set(H, 'Tag', 'PlotRateTimeLeg', 'UserData', 'Graph');    
         set(get(H, 'Children'), 'Tag', 'PlotRateTimeLeg', 'UserData', 'Graph');
         
         % === Angle to Ground Station ===
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotAntPoint', 'Type', 'axes'))
         for i=1:N_GS
            H = plot(180/pi*LONsc, 180/pi*AGLgs2ant(i,:),'-');
            set(H, 'Tag', 'PlotAntPoint', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
         end
         ...
         delete(findobj(gcf,'Tag','PlotAntPointLeg', 'Type', 'axes'));
         ...
         set(H, 'Tag', 'PlotAntPointLeg', 'UserData', 'Graph');
         set(get(H, 'Children'), 'Tag', 'PlotAntPointLeg', 'UserData', 'Graph');          
         
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotAntPointTime', 'Type', 'axes'))
         for i=1:N_GS
            H = plot(t./60, 180/pi*AGLgs2ant(i,:),'-');
            set(H, 'Tag', 'PlotAntPointTime', 'UserData', 'Graph', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
         end
         ...
         delete(findobj(gcf,'Tag','PlotAntPointTimeLeg', 'Type', 'axes'));
         ...
         set(H, 'Tag', 'PlotAntPointTimeLeg', 'UserData', 'Graph');
         set(get(H, 'Children'), 'Tag', 'PlotAntPointTimeLeg', 'UserData', 'Graph');           
      end
      
      %============================================================
      % Ground Trace 2-D Plot
      %============================================================
      if get(findobj(gcf,'Tag','CheckBoxPlotTrace'),'Value')
         fprintf('*')
         LocalDisplay('*', 'add')      
         ...
         LocalDisplay('*', 'add')
         subplot(findobj(gcf,'Tag','PlotGroundTrace', 'Type', 'axes'))%,'XGrid','on'));%'Box','off'));%,'ButtonDownFcn',''));
         % Plot ground traces
         ...
         for i=1:N_GS
            H = plot(LON_GS(i)*180/pi, LAT_GS(i)*180/pi, '.-', 'markersize',8,...
               'Tag','PlotGroundTrace', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
         end
         delete(findobj(gcf,'Tag','PlotGroundTraceLeg', 'Type', 'axes'));
         ...
         set(H, 'Tag', 'PlotGroundTraceLeg','Position',[0.45 0.505 0.14 0.20]);    
         set(get(H, 'Children'), 'Tag', 'PlotGroundTraceLeg'); 
         subplot(findobj(gcf,'Tag','PlotGroundTrace', 'Type', 'axes'));         
         ...
         for i=1:N_GS
            H = plot(LON_GS(i)*180/pi, LAT_GS(i)*180/pi, '+');
            set(H, 'Tag','PlotGroundTrace', 'markersize',8, 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
            H = plotTrace(LLgs_cir0(2*i-1,:)*180/pi, LLgs_cir0(2*i,:)*180/pi, 'b--');
            set(H, 'Tag','PlotGroundTrace','markersize',6,'linewidth',2, 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
            H = plotTrace(LLgs_cirMEL(2*i-1,:)*180/pi, LLgs_cirMEL(2*i,:)*180/pi, 'b-');
            set(H, 'Tag','PlotGroundTrace','markersize',6,'linewidth',2, 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
            H = plotTrace(LONsc_link(i,:)*180/pi, LATsc_link(i,:)*180/pi, '-'); 
            set(H, 'Tag','PlotGroundTrace','markersize',6,'linewidth',2, 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
            H = text(LON_GS(i)*180/pi+3, LAT_GS(i)*180/pi-2, NAME_GS(i,:), 'fontweight', 'bold');
            set(H, 'Tag','PlotGroundTrace', 'color', [(i-1)/max(1,(N_GS-1)) 0 1-(i-1)/max(1,(N_GS-1))/2]);
         end
      end
      
      
      if get(findobj(gcf,'Tag','CheckBoxPlot3D'),'Value')
         %============================================================
         ...
         for i=1:N_GS
            plot3(XYZgs_cir0_geo(3*i-2,:),XYZgs_cir0_geo(3*i-1,:),XYZgs_cir0_geo(3*i,:),'y--',...
               'linewidth',2,'Parent', A3Dgeo,'Tag','PlotTrace3Dgeo');
            plot3(XYZgs_cirMEL_geo(3*i-2,:),XYZgs_cirMEL_geo(3*i-1,:),XYZgs_cirMEL_geo(3*i,:),'y-',...
               'linewidth',2,'Parent', A3Dgeo,'Tag','PlotTrace3Dgeo');
            plot3(XYZgs_geo(3*i-2),XYZgs_geo(3*i-1),XYZgs_geo(3*i),'y+',...
               'linewidth',2,'Parent', A3Dgeo,'Tag','PlotTrace3Dgeo');
         end
      ...
      figure(findobj('Tag', 'ControlWindow'));
      LocalDisplay('*|  completed.', 'add')
...
elseif strcmp(action,'scInfo')
   HelpStr={'';
      ...
      ' ----------------------';
      ' Enter the spacecraft parameters. The fields will update automatically';
      ' ';
      ' FIELDS DESCRIPTION';
      ' ------------------';
      ...
      ' Width [m]    : spacecraft square base dimention';
      ' Length [m]   : length along the P-POD loading axis (also body z-axis)';
      ' Face 1 [m²]  : square base area';
      ' Face 2 [m²]  : long faces area';
      ' Wall [mm]    : external wall thickness for all 6 sides';
      ' Drag coef [] : atmospheric drag coefficient Cd (usually 1 to 4)';
      ' Cb [kg/m²]   : ballistic coefficient (mass/Cd/Area)';
      ' PV eff %     : solar cells (photovoltaics) efficiency on the base faces';
      ' PV eff %     : solar cells (photovoltaics) efficiency on the side faces';
      ' PV pack %    : solar cells (PV) packing factor on the base faces';
      ' PV pack %    : solar cells (PV) packing factor on the side faces';
...
elseif strcmp(action,'magInfo')
   HelpStr={'';
      ...
      '             which is equivalent to be along the NORTH of a magnet';
      '             (the direction vector will be made unitary during process)';
...
elseif strcmp(action,'gsInfo')
   HelpStr={'';
      ' GROUND STATIONS';
      ' ---------------';
      ' Enter the parameters for up to three ground stations.';
      ' ';
      ' FIELDS DESCRIPTION';
      ' ------------------';
...
elseif strcmp(action,'history')
   DataStr = get(findobj(gcf,'Tag','ButtonHistory'),'UserData');
...
elseif strcmp(action,'hideLeg')
   if get(findobj(gcf,'Tag','CheckBoxPlotHide'),'Value')
      set(findobj(gcf,'Tag','PlotGroundTraceLeg'),'visible','off')
   else
      set(findobj(gcf,'Tag','PlotGroundTraceLeg'),'visible','on')
   end
...
elseif strcmp(action,'plotHyst')
   Bs = sscanf(get(findobj(gcf, 'Tag', 'EditTextBs1'),'String'), '%f');	%[A/m^2]
   Br = 0.35;
   Hc = 1.59;
...
elseif strcmp(action,'plotOrbit')
   ...
   subplot(findobj(gcf,'Tag','PlotOrbShape', 'Type', 'axes'));%,'ButtonDownFcn',''));
   cla;
   delete(findobj(gcf,'Tag','PlotOrbShapeLeg', 'Type', 'axes'))
...
function LocalUpdateGraphs();
   F = findobj(gcf, 'UserData', 'Graph');
   for i=1:length(F)
       set(F(i),'Visible','off');
   end
   Popup = findobj(gcf, 'Tag', 'PopupPlot');
...
function LocalDisplay(inStr, loc);
   H = findobj(findobj('Tag', 'ControlWindow'),'Tag','TextDisplay');
   if strcmp(loc, 'add')
...
function  LocalDisplayInfo();
   HelpStr={
      ...
      '    ';
      '    version 2.2.2, SNovember 5, 2002.';
      '    ';
      '    Copyright (C) 2002-2003 Jean-Francois Levesque';
      '    ';
      ' This software is provided ''as-is'', without any express or implied';
